...
struct distancePolicy
{
    ...
    inline auto static difference(const indexCellData & iCell, const indexCellData & jCell, int iSubCellIndex,int jSubCellIndex, const Real * particles, int d,int N,Real wrap)
    {
    ...
    inline auto static difference(const particleCellData3d & iCell, const particleCellData3d & jCell, int iSubCellIndex,int jSubCellIndex, const Real * particles, int d,int N,Real wrap)
    {
...
{
    static bool accept(int i, int j, int iStart, int iEnd)
    {
